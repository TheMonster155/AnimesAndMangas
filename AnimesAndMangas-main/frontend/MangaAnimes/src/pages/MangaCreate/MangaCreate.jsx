...
const CreateManga = () => {
  const [formData, setFormData] = useState({
    ...
    file: null,
    description: "",
    type: "", // Qui aggiungi il campo 'type'
    availability: "", // Disponibilità (solo per Figure)
    genres: [], // Array di generi selezionati
  });
  ...
  const handleCheckboxChange = (e, genre) => {
    if (e.target.checked) {
      // Aggiungi il genere se è selezionato
      setFormData((prevData) => ({
        ...prevData,
        genres: [...prevData.genres, genre],
      }));
    } else {
      // Rimuovi il genere se deselezionato
      setFormData((prevData) => ({
        ...prevData,
